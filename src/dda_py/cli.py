...
def main() -> None:
    ...
    parser.add_argument("--channels", nargs="+", type=int, required=True, help="1-based channel indices")
    parser.add_argument("--flavors", nargs="+", default=None, help="DDA flavors (ST, CT, CD, DE, SY)")
    parser.add_argument("--variants", nargs="+", default=None, help="Compatibility alias for --flavors")
    parser.add_argument("--select", nargs="+", type=int, default=None, help="Explicit 6-bit -SELECT mask")
    parser.add_argument("--format", choices=["ascii", "edf"], default=None, help="Override input file type")
    ...
    parser.add_argument("--dm", type=int, default=Defaults.MODEL_DIMENSION, help="Derivative points passed as -dm")
    ...
    parser.add_argument("--time-range", nargs=2, type=float, default=None, metavar=("START", "STOP"))
    parser.add_argument("--sr", nargs="+", type=int, default=None, help="Sampling rate: one value or two values")
    ...
    parser.add_argument("--tau2", nargs="+", type=int, default=None, help="Pass -TAU2 values")
    parser.add_argument("--model2", nargs="+", type=int, default=None, help="Pass -MODEL2 values")
    parser.add_argument("--no-norm", action="store_true", help="Pass -NoNorm")
    parser.add_argument("--wn-list", nargs="+", type=int, default=None, help="Pass -WN_list values")
